...
\php{app/Http/Controllers/ArticleController.php}{09-controllers/figures/01-ArticleController}
...
First, tell the \texttt{ArticleController} where to find your \texttt{Article} model class:

\php{app/Http/Controllers/ArticleController.php}{09-controllers/figures/02-use}

Then update your \texttt{index} method:

\php{app/Http/Controllers/ArticleController.php}{09-controllers/figures/03-index}
...
\php{app/Http/Controllers/ArticleController.php}{09-controllers/figures/04-ArticleController}
...
\php{app/Http/Controllers/ArticleController.php}{09-controllers/figures/06-show}
...
\php{app/Http/Controllers/ArticleController.php}{09-controllers/figures/07-rmb}
