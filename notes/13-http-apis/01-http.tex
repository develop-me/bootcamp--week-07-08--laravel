...
\begin{infobox}{The Internet vs. The Web}
    ...
    \img{12cm}{13-http-apis/img/arpa-net}{1em}{The internet was so small in 1977 that you could map every computer connected to it on a piece of A4 (\href{http://som.csudh.edu/fac/lpress/history/arpamaps/}{source})}
