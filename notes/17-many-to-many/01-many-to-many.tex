...
\phpinputminted{17-many-to-many/figures/01-migration-up}
...
\phpinputminted{17-many-to-many/figures/02-migration-down}
...
\phpinputminted{17-many-to-many/figures/03-timestamps}
...
\phpinputminted{17-many-to-many/figures/04-tag-relationship}
...
\phpinputminted{17-many-to-many/figures/05-article-relationship}
...
\phpinputminted{17-many-to-many/figures/09-Articles-tags}
...
\phpinputminted{17-many-to-many/figures/10-Article-setTags}

And then update the \texttt{Articles} controller:

\phpinputminted{17-many-to-many/figures/11-Articles-tags-redux}
...
\phpinputminted{17-many-to-many/figures/12-validation}
...
\phpinputminted{17-many-to-many/figures/13-resource}
