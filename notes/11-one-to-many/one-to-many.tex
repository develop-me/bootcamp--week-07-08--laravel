...
\php{app/Models/Article.php}{11-one-to-many/figures/02-Article}
...
\php{app/Models/Comment.php}{11-one-to-many/figures/03-Comment}
...
\php{app/Models/Comment.php}{11-one-to-many/figures/10-fillable}
