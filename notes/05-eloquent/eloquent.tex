...
\php{app/Models/Article.php}{05-eloquent/figures/04-Article}
...
We can also set the properties of an model when we create it:
...
Give this a go and you'll see an error:
...
\php{app/Models/Article.php}{05-eloquent/figures/05-fillable}
