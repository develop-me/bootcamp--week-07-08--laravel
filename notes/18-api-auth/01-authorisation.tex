...
\php{app/Models/User.php}{18-api-auth/figures/01-HasApiTokens}
...
\php{app/Providers/AuthServiceProvider.php}{18-api-auth/figures/02-AuthServiceProvider}


Finally, set the driver of the \texttt{api} authorisation guard to \texttt{passport}:

\php{config/auth.php}{18-api-auth/figures/03-auth-config}
...
\php{routes/api.php}{18-api-auth/figures/04-auth-route}
...
\php{routes/api.php}{18-api-auth/figures/05-auth-route-group}
...
\php{database/migrations/<timestamp>\_modify\_users\_table.php}{18-api-auth/figures/06-ModifyUsersTable}
...
\php{app/Models/User.php}{18-api-auth/figures/07-User}
...
\begin{minted}{php}
    App\Models\User::where('email', 'an.author@gmail.com')
            ->update(['role' => 'author']);
...
\php{app/Http/Requests/API/ArticleStoreRequest.php}{18-api-auth/figures/08-rules}

But let's write a conditional outcome in the \texttt{authorize()} method:

\php{app/Http/Requests/API/ArticleStoreRequest.php}{18-api-auth/figures/09-authorize}

We'll need to tell the \texttt{store()} method in the \texttt{Articles} controller to use this new \texttt{Request}:

\php{app/Http/Controllers/API/Articles.php}{18-api-auth/figures/10-Articles}
