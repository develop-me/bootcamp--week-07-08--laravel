...
\img{12cm}{03/img/one-to-many.eps}{1em}{One-to-many relationships}
...
\phpinputminted{03/figures/03/01-migration}
...
\phpinputminted{03/figures/03/02-Article}
...
\phpinputminted{03/figures/03/03-Comment}
...
\phpinputminted{03/figures/03/04-tinker}
...
\phpinputminted{03/figures/03/05-routes}
...
\phpinputminted{03/figures/03/07-store}
...
\phpinputminted{03/figures/03/08-fillable}
...
\phpinputminted{03/figures/03/09-CommentRequest}
...
\phpinputminted{03/figures/03/10-request-type-hint}
...
\phpinputminted{03/figures/03/11-resource}
...
\phpinputminted{03/figures/03/12-controller-resource}
