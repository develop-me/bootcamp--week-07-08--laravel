...
\php{app/Http/Controllers/API/Articles.php}{14-validation-resources/figures/02-use}

Then update the controller methods to use this instead of \texttt{Request}:

\php{app/Http/Controllers/API/Articles.php}{14-validation-resources/figures/03-type-hint}
...
\php{app/Http/Resources/API/ArticleResource.php}{14-validation-resources/figures/05-use}

Then we need to update all of the methods that return an article to use the resource:

\php{app/Http/Controllers/API/Articles.php}{14-validation-resources/figures/06-resource-controller}
...
\php{app/Http/Controllers/API/Articles.php}{14-validation-resources/figures/08-use}
...
\php{app/Http/Controllers/API/Articles.php}{14-validation-resources/figures/09-index-resource-controller}
