...
\php{app/Http/Controllers/API/Articles.php}{13-laravel-api/figures/02-use}

Now, update \texttt{index} method:

\php{app/Http/Controllers/API/Articles.php}{13-laravel-api/figures/03-index}
...
\php{app/Http/Controllers/API/Articles.php}{13-laravel-api/figures/05-show}
...
\php{app/Http/Controllers/API/Articles.php}{13-laravel-api/figures/06-destroy}
...
\php{app/Http/Controllers/API/Articles.php}{13-laravel-api/figures/07-store}
...
\php{app/Http/Controllers/API/Articles.php}{13-laravel-api/figures/08-update}
