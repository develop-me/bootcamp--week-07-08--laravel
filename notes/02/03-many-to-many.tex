...
We want to create a method that takes an array of strings and gives us back an array of \texttt{Tag} models. This should be a \texttt{static} method on the \texttt{Tag} class.
\\
...
\textbf{Run your tests}. \textbf{Red}. Let's get it \textbf{green}:
...
\textbf{Run your tests}. \textbf{Green}. But our method isn't done. It should store the tag in the database. Let's add another assertion:
