...
\stdinputminted[firstline=3]{php}{02/figures/02/02-migration-up.php}
...
\phpinputminted{02/figures/02/03-tinker-model}
...
\phpinputminted{02/figures/02/04-Article}
...
\phpinputminted{02/figures/02/05-Article-id}
...
\phpinputminted{02/figures/02/06-Article-update}
