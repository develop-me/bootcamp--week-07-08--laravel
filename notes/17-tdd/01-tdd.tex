...
\php{app/RomanNumeral.php}{17-tdd/figures/01-RomanNumeral}
...
\php{tests/Unit/RomanNumeralTest.php}{17-tdd/figures/02-RomanNumeralTest}


Right, let's get our first fail. In \texttt{RomanNumeralTest}:

\php{tests/Unit/RomanNumeralTest.php}{17-tdd/figures/03-test1}
...
\php{app/RomanNumeral.php}{17-tdd/figures/04-forNumber}
...
\php{app/RomanNumeral.php}{17-tdd/figures/05-forNumber}
...
\php{tests/Unit/RomanNumeralTest.php}{17-tdd/figures/06-test2}
...
\php{app/RomanNumeral.php}{17-tdd/figures/07-forNumber}
...
\php{tests/Unit/RomanNumeralTest.php}{17-tdd/figures/08-test3}

\pagebreak

\textbf{Run your tests}. \textbf{Red}. And let's get it working:

\php{app/RomanNumeral.php}{17-tdd/figures/09-forNumber}
...
\php{app/RomanNumeral.php}{17-tdd/figures/10-forNumber}
...
\php{tests/Unit/RomanNumeralTest.php}{17-tdd/figures/11-test4}
...
\php{app/RomanNumeral.php}{17-tdd/figures/12-forNumber}


Next test:

\php{tests/Unit/RomanNumeralTest.php}{17-tdd/figures/13-test5}

\textbf{Run your tests}. \textbf{Red} again. Let's fix it:


\php{app/RomanNumeral.php}{17-tdd/figures/14-forNumber}
...
\php{app/RomanNumeral.php}{17-tdd/figures/15-forNumber}
...
\php{tests/Unit/RomanNumeralTest.php}{17-tdd/figures/16-test6}
...
\php{app/RomanNumeral.php}{17-tdd/figures/17-forNumber}


\textbf{Test}. \textbf{Green}. Can't see a pattern, so move on.

\php{tests/Unit/RomanNumeralTest.php}{17-tdd/figures/18-test7}
...
\php{app/RomanNumeral.php}{17-tdd/figures/19-forNumber}


\textbf{Test}. \textbf{Green}. An inkling of a pattern now, but let's make sure.

\php{tests/Unit/RomanNumeralTest.php}{17-tdd/figures/20-test8}
...
\php{app/RomanNumeral.php}{17-tdd/figures/21-forNumber}
...
\php{app/RomanNumeral.php}{17-tdd/figures/22-forNumber}
...
\php{tests/Unit/RomanNumeralTest.php}{17-tdd/figures/23-test9}
...
\php{app/RomanNumeral.php}{17-tdd/figures/24-forNumber}
...
\php{tests/Unit/RomanNumeralTest.php}{17-tdd/figures/25-test10}
...
\php{app/RomanNumeral.php}{17-tdd/figures/26-forNumber}
...
\php{tests/Unit/RomanNumeralTest.php}{17-tdd/figures/27-test11}
...
\php{tests/Unit/RomanNumeralTest.php}{17-tdd/figures/28-test20}
...
\php{app/RomanNumeral.php}{17-tdd/figures/29-forNumber}
...
\php{tests/Unit/RomanNumeralTest.php}{17-tdd/figures/30-test30}
...
\php{app/RomanNumeral.php}{17-tdd/figures/31-forNumber}
...
\php{app/RomanNumeral.php}{17-tdd/figures/32-forNumber}
...
\php{app/RomanNumeral.php}{17-tdd/figures/33-forNumber}
...
\code{.git/hooks/pre-commit}{bash}{17-tdd/figures/34-hook.sh}
