...
\code{resources/views/comments/form.blade.php}{php}{15-one-to-many/figures/05-comments-form.blade.php}
...
\code{resources/views/article.blade.php}{html}{15-one-to-many/figures/06-article.blade.php}

When we submit this form it's going to \texttt{POST} to \texttt{/articles/{article}}, so next we'll need to setup a route:

\php{routes/web.php}{15-one-to-many/figures/07-routes}


Now we'll need to update the \texttt{Articles} controller. First, let the controller know about the \texttt{Comment} model:

\php{app/Http/Controllers/Articles.php}{15-one-to-many/figures/08-Articles-use}

Next, let's add the controller method:

\php{app/Http/Controllers/Articles.php}{15-one-to-many/figures/09-store}
...
\php{app/Models/Comment.php}{15-one-to-many/figures/10-fillable}
...
\php{app/Http/Requests/CommentRequest.php}{15-one-to-many/figures/11-CommentRequest}
...
\php{app/Http/Controllers/Articles.php}{15-one-to-many/figures/11-use}

Then update the type-hinting to use \texttt{CommentRequest} instead of \texttt{Request}:

\php{app/Http/Controllers/Articles.php}{15-one-to-many/figures/12-request-type-hint}
...
\code{resources/views/article.blade.php}{php}{15-one-to-many/figures/13-comments-list.blade.php}
