...
\php{app/Http/Controllers/API/CommentController.php}{15-one-to-many/figures/07-use}


Now, let's add the \texttt{index} method:

\php{app/Http/Controllers/API/CommentController.php}{15-one-to-many/figures/08-index}
...
\php{app/Http/Controllers/API/CommentController.php}{15-one-to-many/figures/09-show}
...
\php{app/Http/Controllers/API/CommentController.php}{15-one-to-many/figures/10-destroy}
...
\php{app/Http/Controllers/API/CommentController.php}{15-one-to-many/figures/15-use}

Then update the type-hinting to use \texttt{CommentRequest} instead of \texttt{Request}:

\php{app/Http/Controllers/API/CommentController.php}{15-one-to-many/figures/16-request-type-hint}
